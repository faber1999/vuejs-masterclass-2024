...
<template>
  <Table v-if="project">
    ...
    <TableRow>
      ...
      <TableCell>
        <div class="flex">
          <Avatar class="-mr-4 border border-primary hover:scale-110 transition-transform" v-for="{profile: collab} in project.collaborators" :key="collab.id">
            <RouterLink
        ...
        <Table>
          ...
          <TableBody>
            <TableRow v-for="task in project.tasks" :key="task.id">
              ...
              <TableCell>
                <AppInPlaceEditStatus v-model="task.status" @commit="updateProject" read-only />
              </TableCell>
