...
const errorsMapper: Record<string, string> = {
...
export const useFormErrors = () => {
  ...
  const handleServerError = (error: AuthError) => {
    serverError.value = errorsMapper[error.message] || error.message
  }
  ...
  return { serverError, handleServerError, handleLoginForm, realtimeErrors }
}
